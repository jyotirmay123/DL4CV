...
from utils.utils import extract_left_eye_center, extract_right_eye_center, get_rotation_matrix, crop_image
...
def img_align(pathname, label=None):
    ...
    predictor = dlib.shape_predictor("utils/pretrained_model/shape_predictor_68_face_landmarks.dat")
    ...
    for i, det in enumerate(dets):
        ...
        if label != None:
            ...
            cv2.imwrite(f"data/alligned/{emo_list[label]}/{image_name}", cropped)
